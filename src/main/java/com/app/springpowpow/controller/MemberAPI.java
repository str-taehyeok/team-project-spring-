...
////////////////////////////////////////////////////////////////////////////////////////// 아이디 찾기
    ...
    @Parameters({
            @Parameter(name = "memberPhone", description = "회원의 휴대폰 번호", schema = @Schema(type = "string", example = "01024003252", description = "회원의 전화번호를 입력해주세요."), required = true)
    })
    ...
    public ResponseEntity<Map<String, Object>> findMemberByIdAndPhone(@PathVariable String memberPhone) throws IOException {
        ...
        String foundUser = memberService.findEmail(memberPhone);
        ...
        String memberEmail = foundUser;

        // 3) 이메일로 유저를 찾을 수 있는 쿼리를 만든다.(정보 조회)
        List<MemberVO> members = memberService.findMember(memberEmail);
