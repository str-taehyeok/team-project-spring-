...
public class CommentDTO {
    ...
    @Schema(description = "댓글 작성자 ID", example = "21")
    private Long memberId;

    @Schema(description = "게시물 ID", example = "1001")
    private Long postId;

    @Schema(description = "댓글 내용", example = "이 게시물에 대해 너무 좋아요!")
    private String commentContent;

    @Schema(description = "게시물 내용", example = "이곳은 정말 좋은 장소입니다!")
    private String postContent;

    @Schema(description = "게시물 이미지 URL", example = "https://example.com/post-image.jpg")
    private String postImage;

    @Schema(description = "게시물 색상", example = "blue")
